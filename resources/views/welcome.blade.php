...
<head>
	...
	<!-- Styles -->
	<link rel='stylesheet' href='{{ asset('assets') }}/css/me.css' type='text/css' media='screen' />
...
<div class="fs-me">
	...
	<div class="me-content">
        ...
        @if (Route::has('login'))
		<div class="bio">
            <p>SMK Amin, SMK HEBAT-BISA.
            @auth
            Sepertinya anda sudah login
			<a href="{{ url('/dashboard') }}">Dashboard</a>
                @else
                <a href="{{ route('login') }}">Login</a> jika anda memiliki akun
                @if (Route::has('register'))
                Atau
                <a href="{{ route('register') }}">Register</a> Jika Anda Tidak Memiliki Akun.</p>
                @endif
                @endauth
