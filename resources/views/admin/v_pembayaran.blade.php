...
<livewire:pembayaran-list> --}}
    <a href="/dashboard/pembayaran/add/{{ $siswa->id }}" class="btn btn-primary">+ Tambah Data</a>
    ...
    <thead class="thead-inverse">
        ...
        @if ($aman->id_pembayaran > 0)
            <tr>
                ...
                <a class="btn btn-info btn-sm" href="/dashboard/pembayaran/edit/{{ $aman->id_pembayaran }}/{{ $siswa->id }}">
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content bg-danger">
        ...
        <div class="modal-body">
          <p>Klik simpan untuk menghapus&hellip;</p>
        </div>
        <div class="modal-footer justify-content-between">
          <button type="button" class="btn btn-outline-light" data-dismiss="modal">BATAL</button>
          <button onclick="window.location.href='/dashboard/pembayaran/delete/{{ $hapus->id_pembayaran }}'" class="btn btn-outline-light">SIMPAN</button>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
